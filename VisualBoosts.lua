...
local function runMainScript()
    ...
    local Games = loadstring(game:HttpGet("https://api.junkie-development.de/api/v1/luascripts/public/e5b15938be90735e7df205371f87cf5ea4738322f2e3e5a073e52b78e767b65f/download"))()
